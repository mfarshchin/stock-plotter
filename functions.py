...
def plot_price_vol(df, df_v, stock):
    ...
    p = figure(plot_width=1600, plot_height=600, title=f'Stock name: "{stock["name"]}"', background_fill_color="#fafafa", tools='wheel_zoom,box_zoom,pan,reset,save',y_range=(lowst, max_prc+0.1*rng))
